export function htmlContent(otp, firstName, formattedDateString) {
  ...
  <html lang="en">
     ...
     <body style="background-color:#ffffff;margin:0 auto;padding:1rem;font-family:-apple-system, BlinkMacSystemFont, &#x27;Segoe UI&#x27;, &#x27;Roboto&#x27;, &#x27;Oxygen&#x27;, &#x27;Ubuntu&#x27;, &#x27;Cantarell&#x27;, &#x27;Fira Sans&#x27;, &#x27;Droid Sans&#x27;, &#x27;Helvetica Neue&#x27;, sans-serif">
        <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%" style="max-width:600px;margin:0 auto">
           <tr style="width:100%">
              <td>
                 <h5 style="color:#1d1c1d;font-size:24px;margin:30px 0;padding:0;line-height:42px">Hi ${firstName},</h5>
                
                 <p style="font-size:16px;line-height:28px;margin:16px 0;margin-bottom:30px">Use the following one-time password(OTP) to verify your JWtours email.
                 <br>
                This OTP will be valid for 5 minutes till ${formattedDateString}</p>
                 <div><h5 style="color:#1d1c1d;font-size:24px;margin:30px 0;padding:0;line-height:42px">${otp}</h5></div>
