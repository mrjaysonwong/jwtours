export function htmlContent(link, email) {
         ...
         <tr style="width:100%">
            <td>
               <table style="margin-top:32px" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
                  <tbody>
                     <tr>
                        <td><img alt="JWtours" src="https://res.cloudinary.com/dpyxciwcu/image/upload/v1695451277/JWtours/JWtours_uactyl.png" width="120" height="40" style="display:block;outline:none;border:none;text-decoration:none" /></td>
                     </tr>
                  </tbody>
               </table>
                        ...
                        <td>
                           <table width="100%" style="margin-bottom:32px;padding-left:8px;padding-right:8px;width:100%" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                              <tbody style="width:100%">
                                 <tr style="width:100%">
                                    <td style="width:66%"><img alt="JWtours" src="https://res.cloudinary.com/dpyxciwcu/image/upload/v1695451277/JWtours/JWtours_uactyl.png" width="120" height="40" style="display:block;outline:none;border:none;text-decoration:none" /></td>
                                    <td>
